...
import com.BusReservationSystem.firstProject.DTO.ReservationDTO;
import com.BusReservationSystem.firstProject.helper.ObjectCreationHelper;
import com.BusReservationSystem.firstProject.model.Bookings;
import com.BusReservationSystem.firstProject.model.BusData;
import com.BusReservationSystem.firstProject.model.User;
import com.BusReservationSystem.firstProject.repository.BookingsRepository;
import com.BusReservationSystem.firstProject.repository.BusDataRepository;
import com.BusReservationSystem.firstProject.repository.UserRepository;
...
public class DashboardController {
    ...
    //redirect here after you click on the pay button
    @PostMapping("/booking")
    public String finalBooking(@ModelAttribute("record") BookingsDTO bookingDTO,Model model) {
        //fetches user details from the spring security session
